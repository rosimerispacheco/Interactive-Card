...
//        --  Formate o campo de entrada "Número do cartão" ao digitar  --
//       Isso atualiza o campo de entrada quando o usuário está digitando
//       e adicione espaços em branco após quatro números.

const creditCardFormat = (numbers) => {
  //  Verificando mais de 4 números na string
  //  remova espaços em branco e formate a entrada
  if (numbers.length >= 4 && keyPress !== "Backspace") {
    ...
    numbCardInput.value = newNumbers; // Troque os números antigos pelos novos formatados no campo de entrada
  } else if (
    // Remova os espaços em branco ao delimitar a entrada para que o usuário exclua apenas números
